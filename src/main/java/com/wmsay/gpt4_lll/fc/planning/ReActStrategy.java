...
import com.wmsay.gpt4_lll.fc.planning.ExecutionHook.HookAction;
...
public class ReActStrategy implements ExecutionStrategy {
    ...
    public FunctionCallResult execute(FunctionCallRequest request,
        ...
        return executeReActLoop(request, toolContext, llmCaller, callback, ctx,
    ...
    public FunctionCallResult executeReActLoop(FunctionCallRequest request,
        ...
        StreamingLlmCaller streamingLlmCaller = ctx.getStreamingLlmCaller();
        ...
        try {
            ...
            // 2. 对话循环
            String lastCollectedText = "";
            for (int round = 0; round < maxRounds; round++) {
                // Check for thread interrupt (Stop button cancellation)
                if (Thread.currentThread().isInterrupted()) {
                    return FunctionCallResult.success(
                            lastCollectedText.isEmpty() ? null : lastCollectedText,
                            sessionId, toolCallHistory);
                }
                ...
                if (useStreaming) {
                    ...
                    com.wmsay.gpt4_lll.fc.llm.StreamingFcCollector.DisplayCallback displayCb =
                ...
                List<ToolCallResult> roundResults = executeToolCalls(
                        toolCalls, toolContext, sessionId, callback,
                ...
                // Track collected text for interrupt-based partial return
                if (!textContent.isEmpty()) {
                    lastCollectedText = textContent;
                }
            }
    ...
    List<ToolCallResult> executeToolCalls(List<ToolCall> toolCalls,
        ...
        for (ToolCall toolCall : toolCalls) {
            ...
            try {
                ...
                ToolResult toolResult = executionEngine.execute(toolCall, context);
